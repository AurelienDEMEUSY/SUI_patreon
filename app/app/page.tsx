    ...
    <div className="bg-black font-sans text-gray-300 antialiased selection:bg-[#3c3cf6]/30 selection:text-white min-h-screen">
      ...
      <main className="relative pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          {/* Stats Visual */}
          <FadeIn delay={1.0} className="w-full">
      ...
      <section className="py-20 border-y border-white/5 bg-black/50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <StaggerContainer className="flex flex-wrap justify-center gap-8 md:gap-16 items-center">
          ...
          <div className="grid md:grid-cols-2 gap-24 items-center">
            ...
            <div className="relative">
              <div className="relative p-8 aspect-square flex items-center justify-center overflow-hidden">
                <Globe className="w-full h-full bg-transparent" />
      ...
      <section className="py-32 px-6">
        <FadeIn delay={0.2} className="max-w-5xl mx-auto">
          <div className="rounded-[3rem] bg-[#3c3cf6] overflow-hidden relative group">
